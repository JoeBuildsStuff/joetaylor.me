...
export default function Signup({
  ...
  const signUp = async (formData: FormData) => {
    ...
    if (error) {
      return redirect("/signup?message=Could not create an account");
    }
      ...
      <Card className="">
        ...
        <CardContent>
          <div className="grid gap-4">
            <form action={signUp} method="post" className="grid gap-4">
          ...
          <div className="mt-8 text-center text-sm">
            ...
            <Link href="/signin" className="ml-4 underline">
              Sign in
            </Link>
          </div>
        </CardContent>
